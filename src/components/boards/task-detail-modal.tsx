            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setAssignedTo(v === "__unassigned__" ? null : v)
                  }
                >
